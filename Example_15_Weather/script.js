...
const displayResult = (result) =>{
    ...
    if (descrimg=="bulutlu" || descrimg == "az bulutlu" || descrimg == "kapalı" || descrimg == "parçalı az bulutlu" ) {
    ...
    else if (descrimg == "açık" || descrimg == "güneşli") {
        let temptimg = "";
        let img = document.getElementById("imgid");
    ...
    else if (descrimg =="sisli" || descrimg =="hafif sisli") {
        let temptimg = "";
        let img = document.getElementById("imgid");
